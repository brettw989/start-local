...
- `.gitattributes`
- `.gitignore`
- `.markdownlint.yaml` - YAML configuration
- `.yamllint`
...
- `install_edot_test.sh` - Shell script
- `install_esonly_test.sh` - Shell script
- `install_from_curl_test.sh` - Shell script
...
### `tests/docker/` (2 files)
- `host_gateway.sh` - Shell script
- `proxy.sh` - Shell script
